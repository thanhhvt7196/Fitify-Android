package com.example.fitifyandroid.presentation.screens.login
...
import com.example.fitifyandroid.databinding.FragmentLoginBinding
...
import com.example.fitifyandroid.presentation.screens.onboarding.gender.OnboardingGenderFragment
import com.example.fitifyandroid.presentation.screens.onboarding.goal.OnboardingGoalFragment
import com.example.fitifyandroid.presentation.screens.onboarding.name.OnboardingNameFragment
import com.example.fitifyandroid.presentation.screens.loginBottomSheet.LoginType
import com.example.fitifyandroid.presentation.screens.onboarding.activeStatus.OnboardingActiveStatusFragment
import com.example.fitifyandroid.presentation.screens.onboarding.age.OnboardingAgeFragment
import com.example.fitifyandroid.presentation.screens.onboarding.badHabit.OnboardingBadHabitFragment
import com.example.fitifyandroid.presentation.screens.onboarding.commitContract.OnboardingCommitContractFragment
import com.example.fitifyandroid.presentation.screens.onboarding.dailyWalk.OnboardingDailyWalkFragment
import com.example.fitifyandroid.presentation.screens.onboarding.energyLevel.OnboardingEnergyLevelFragment
import com.example.fitifyandroid.presentation.screens.onboarding.fitnessTool.OnboardingFitnessToolFragment
import com.example.fitifyandroid.presentation.screens.onboarding.height.OnboardingHeightFragment
import com.example.fitifyandroid.presentation.screens.onboarding.kneePain.OnboardingKneePainFragment
import com.example.fitifyandroid.presentation.screens.onboarding.planDay.OnboardingPlanDayFragment
import com.example.fitifyandroid.presentation.screens.onboarding.googleFit.OnboardingGoogleFitFragment
import com.example.fitifyandroid.presentation.screens.onboarding.planPace.OnboardingPlanPaceFragment
import com.example.fitifyandroid.presentation.screens.onboarding.pushup.OnboardingPushUpFragment
import com.example.fitifyandroid.presentation.screens.onboarding.salePitch.OnboardingSalePitchFragment
import com.example.fitifyandroid.presentation.screens.onboarding.source.OnboardingSourceFragment
import com.example.fitifyandroid.presentation.screens.onboarding.weight.OnboardingWeightFragment
import com.example.fitifyandroid.presentation.screens.onboarding.workoutFrequency.OnboardingFrequencyFragment
import com.example.fitifyandroid.utils.extensions.getStatusBarHeight
import com.example.fitifyandroid.utils.extensions.play
...
class LoginFragment :
    ...
    private val googleFitFragment = OnboardingGoogleFitFragment.newInstance()
    ...
    private fun resetData() {
        ...
        if (googleFitFragment.isAdded) {
            googleFitFragment.resetData()
        }
    }
